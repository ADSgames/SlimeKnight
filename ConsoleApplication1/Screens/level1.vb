...
Namespace Screens
    Partial Public Class level1
        ...
        'Create Ruins
        Dim frequencyRuins As Integer = 40
        Dim ruins As SpriteList

        'Create towers
        Dim frequencyTowers As Integer = 6
        ...
        Private Sub CustomInitialize()
            ...
            'load the scene
            level1 = tool.loadScene("Content\\level1.scnx", Me.ContentManagerName)
            ...
            SpriteManager.Cameras(2).Orthogonal = True
            SpriteManager.Cameras(2).X = -130
            SpriteManager.Cameras(2).Y = -130
            SpriteManager.Cameras(2).OrthogonalHeight = 400
            SpriteManager.Cameras(2).OrthogonalWidth = 400
            ...
            For counter As Integer = 0 To frequencyRuins
                Dim ruin As Sprite
                ruin = SpriteManager.AddSprite("Content\\images\\stoneblock.png")
            ...
            'Load music
            music = FlatRedBallServices.Load(Of Song)("Content\\sounds\\level1", ContentManagerName)
        ...
        Private Sub CustomActivity(ByVal firstTimeCalled As Boolean)
            ...
            For counter As Integer = 0 To towers.Count
                If counter < towers.Count Then
                    If towers(counter).CollideAgainstMove(character, 1, 0) Then
            ...
            For counter As Integer = 0 To powerups.Count
                If counter < powerups.Count Then
                    If powerups(counter).YVelocity < 0 And powerups(counter).Y < character.Y Then
                        ...
                        tool.mapCollisionRectangle(powerups(counter))
            ...
            'Win level
            If towers.Count < 1 And enemies.Count < 1 Then
                CustomDestroy()
