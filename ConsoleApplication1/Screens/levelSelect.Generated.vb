...
#End If
        ...
        Public Sub New()
            MyBase.New("levelSelect")
        End Sub

        Public Overrides Sub Initialize(ByVal addToManagers__1 As Boolean)
        ...
        Public Overrides Sub Activity(ByVal firstTimeCalled As Boolean)
            ' Generated Activity
        ...
        End Sub
        Public Shared Sub LoadStaticContent(ByVal contentManagerName As String)
#If DEBUG Then
...
#End If
        ...
        Public Shared Function GetStaticMember(ByVal memberName As String) As Object
            Return Nothing
        End Function
        Public Shared Function GetFile(ByVal memberName As String) As Object
            Return Nothing
        End Function
        Private Function GetMember(ByVal memberName As String) As Object
            Return Nothing
        End Function
