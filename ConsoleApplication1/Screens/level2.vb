...
Namespace Screens
    Partial Public Class level2
        ...
        'Create Ruins
        Dim frequencyRuins As Integer = 60
        Dim ruins As SpriteList

        'Create towers
        Dim frequencyTowers As Integer = 9
        ...
        Private Sub CustomInitialize()
            ...
            'load the scene
            level1 = tool.loadScene("Content\\level2.scnx", Me.ContentManagerName)
            ...
            For counter As Integer = 0 To frequencyRuins
                Dim ruin As Sprite
                ruin = SpriteManager.AddSprite("Content\\images\\cactus.png")
            ...
            'Load music
            music = FlatRedBallServices.Load(Of Song)("Content\\sounds\\level2", ContentManagerName)
